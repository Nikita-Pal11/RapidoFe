...
export async function GET(req:NextRequest){
    ...
    const resp = await fetch(`http://127.0.0.1:8000/rides/nearest-driver/?pickup_long=${pickup_long}&pickup_lat=${pickup_lat}&dropoff_long=${dropoff_long}&dropoff_lat=${dropoff_lat}`, {
      method: "GET",
      headers: {
