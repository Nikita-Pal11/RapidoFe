...
import { StarIcon } from "../Driver/icons";
    ...
    <div className="fixed inset-0 z-50 flex" onClick={onClose}>
      ...
      >
        ...
        <Card className="bg-white/[0.03] border-white/5 p-4 rounded-2xl flex flex-row items-center gap-3 mb-6 shadow-xl">
          ...
          <div>
            <p className="text-white font-extrabold text-sm m-0">Rider</p>
            <p className="text-[11px] font-semibold text-white/40 m-0">
              Premium Member
            </p>
        ...
        <div className="flex flex-col gap-1">
          {[
            ...
            const isActive = item === "Book a Ride";
            return (
              <button
                key={item}
                onClick={onClose}
